...
#stores votes associated with particular senator
...
for filename in glob.glob('congress_data/*.csv'):
    with open(filename, encoding = "UTF-8") as file:
        ...
        for person, state, district, vote, name, party in reader:
            # creating senator object from named tuple and storing all of the senator's vote under it's object
...
votes_to_senators:DefaultDict[voteHistory, Senator] = defaultdict(list)
